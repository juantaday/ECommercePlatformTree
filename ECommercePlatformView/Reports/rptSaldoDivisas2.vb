...
Public Class rptSaldoDivisas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ECommercePlatformView.rptSaldoDivisas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaldoDivisas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaldoDivisas = New rptSaldoDivisas()
        rpt.Site = Me.Site
        Return rpt
    End Function
