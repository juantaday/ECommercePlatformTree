...
Public Class rptInventoriesUpdate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInventoriesUpdate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ECommercePlatformView.rptInventoriesUpdate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idInventory() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptInventoriesUpdate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventoriesUpdate = New rptInventoriesUpdate()
        rpt.Site = Me.Site
        Return rpt
    End Function
