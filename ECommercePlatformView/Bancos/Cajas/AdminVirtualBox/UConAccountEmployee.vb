...
Public Class UConAccountEmployee
    ...
    End Sub
    Private Sub UConAccountEmployee_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Using db As New DataContext
                ...
                Try
                    ...
                    Dim _saldoVirtual As Double? = (From v In db.VirtualBox
                                                    Where v.idVirtualBox = MyParent.IdVirtualBox).FirstOrDefault().Saldo

                    Dim newSaldoVirtual As Double = _saldoVirtual - MyParent.MontoDivisa
                    Dim _VirtualBoxDetails As New VirtualBoxDetails With
                {
                    .idVirtualBox = MyParent.IdVirtualBox,
                    .Descripcion = destino & " Autorizado: " & userAurization,
                    .debe = 0,
