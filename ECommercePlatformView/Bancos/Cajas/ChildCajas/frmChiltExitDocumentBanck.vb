Imports CADsisVenta
Public Class frmChiltExitDocumentBanck
    ...
    Private Sub frmChiltExitDocumentBanck_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Function SaveTranfer(idBancocuenta As Integer?, _userAurization As String, _destino As String) As Boolean
        ...
        Try
            ...
            Using db As New DataContext
                ...
                Dim newSaldo As Double = _saldo - Me.MyParent.MontoDivisa
                Dim _Cajas As New Cajas With
                {
                        .idCajaStado = Me.IdCajaStado,
                        .codUserMovi = _userAurization,
                        .debe = 0,
                        .haber = Me.MyParent.MontoDivisa,
