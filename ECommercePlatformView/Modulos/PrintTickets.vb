...
#End Region
#Region "printTicket"
    Public Function Print_Ticket(ByVal idFactur As Integer, Optional isLatest As Boolean = False) As Boolean
        Try
    ...
    Private Function PrintTicket_FacturAndNoteVent(ByVal dC As DataTable, ByVal dT As DataTable) As Boolean
        Try
            '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            'INICIO DE IMPRECION
            '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            Ticket1.Avanza2Lines()
            Dim dieccion = TextoDiseñado("DIRECCION:" + dC.Rows(0)("Direccion"), Alinea.Izquierda, 40)
            Ticket1.TextoIzquierda(dieccion, False)
            Ticket1.Avanza2Lines()
